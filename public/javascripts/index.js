...
var RATING_HINTS, clickedRatingStar, describeScore;

RATING_HINTS = ["Poor", "Below Average", "Average", "Above Average", "Excellent"];

describeScore = function(score) {
  var hint;
...
clickedRatingStar = function(score) {
  $(this).raty("score", score);
  return $("#review-stars-hint").attr("title", "Your selected rating: " + (describeScore(score)));
};

$("#review-stars").raty({
  path: "https://local.intuit.com/b/images",
  size: 24,
